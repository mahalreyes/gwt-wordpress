...
function gwt_wp_scripts() {
	...
	/** js **/
	wp_enqueue_script( 'gwt_wp-jquery', get_template_directory_uri() . '/foundation/js/vendor/jquery.js', array(), '20160530', false );
	...
	wp_enqueue_script( 'gwt_wp-foundation-app', get_template_directory_uri() . '/foundation/js/app.js', array(), '20160530', true );
